...
public class InternalMessageTest extends TestCase {
    ...
    public void testStatusCodes(){
        ...
        assertTrue((STATUS_INVALID_DESTINATION & messageWrongEndpoint.statusCode) > 0);
        ...
        assertTrue((STATUS_INVALID_DESTINATION & messageInternalFaultUnknownDestination.statusCode) > 0);
